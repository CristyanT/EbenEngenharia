  ...
  return (
    ...
    >
      <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.553 4.127 1.52 5.867L0 24l6.307-1.654A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75c-1.89 0-3.67-.504-5.203-1.387l-.373-.222-3.868 1.014 1.032-3.77-.244-.388A9.71 9.71 0 012.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75z" />
      </svg>
    </a>
  );
}
